...
data class Course(val name: String, val teacher: String, val center: String, val lectures: Int)
...
//This function will generate the array list if type courses(class). It will be required as we want to set up these in our eachView
